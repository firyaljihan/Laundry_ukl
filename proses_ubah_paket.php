...
if($_POST){
    ...
    if(empty($jenis_paket)){
        echo "<script>alert('jenis paket tidak boleh kosong');location.href='ubah_paket.php?id_paket=".$id_paket."';</script>";

    } elseif(empty($harga)){
        echo "<script>alert('harga tidak boleh kosong');location.href='ubah_paket.php?id_paket=".$id_paket."';</script>";
    } else {
        include "koneksi.php";
